    ...
    <div class="flex flex-col md:flex-row h-full">
      ...
      <div class="w-full md:w-1/3 bg-white p-4 flex flex-col relative">
        ...
        <div class="flex flex-col h-full overflow-y-hidden p-2 justify-end">
          <div class="overflow-y-auto custom-scrollbar scroll-smooth" ref="bidsContainer" @scroll="handleScroll">
            <div
              ...
              <a-card-meta class="w-full">
                <template #title>
                  <div class="flex justify-between w-full">
                    <div>{{ bid?.name + ' bid ' + bid?.price?.toLocaleString('vi-VN') + ' VND' }}</div>
      ...
      <div v-if="showNotify"
        ...
        <div class="p-2 overflow-y-auto custom-scrollbar scroll-smooth min-h-[200px] max-h-[450px]" ref="NotifiesContainer" @scroll="handleScrollNotify">
...
function addComment(data) {
  let { commentId, userId, content, createdAt } = data;
  if (showComments.value) {
    newCommentCount.value = 0;
  } else {
